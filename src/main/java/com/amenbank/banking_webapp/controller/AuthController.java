...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> confirmEnable2fa(
        ...
        return ResponseEntity.ok(authService.confirmEnable2fa(userDetails.getUsername(), body.get("code")));
    }
    ...
    public ResponseEntity<AuthResponse> verify2fa(@RequestBody Map<String, String> body) {
        return ResponseEntity.ok(authService.verify2fa(body.get("tempToken"), body.get("code")));
    }
    ...
    public ResponseEntity<Map<String, String>> disable2fa(
            @AuthenticationPrincipal UserDetails userDetails,
            @RequestBody Map<String, String> body) {
        return ResponseEntity.ok(authService.disable2fa(userDetails.getUsername(), body.get("code")));
    }

    // ── Password Change (fix #11) ────────────────────────
