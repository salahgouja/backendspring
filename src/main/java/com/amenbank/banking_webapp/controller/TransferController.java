...
public class TransferController {
    ...
    @GetMapping
    @Operation(summary = "Lister mes virements", description = "Retourne tous les virements envoyés par l'utilisateur connecté.")
    public ResponseEntity<List<TransferResponse>> getMyTransfers(
            @AuthenticationPrincipal UserDetails userDetails) {
        return ResponseEntity.ok(transferService.getUserTransfers(userDetails.getUsername()));
    }
